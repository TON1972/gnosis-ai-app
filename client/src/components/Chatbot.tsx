...
const KNOWLEDGE_BASE = {
  ...
  diferencas_planos: {
    message: "**Principais diferenças:**\n\n**FREE** - 6 ferramentas básicas, 500+50 créditos\n**ALIANÇA** - 10 ferramentas, 1500+100 créditos\n**LUMEN** - Todas as 17 ferramentas, 3000+200 créditos\n**PREMIUM** - Todas as 17 ferramentas, 6000+300 créditos\n\nPlanos pagos incluem ferramentas avançadas como Exegese, Patrística, Linha do Tempo Teológica e muito mais.",
    options: [
    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-24 right-6 z-50 bg-[#d4af37] text-[#1e3a5f] p-4 rounded-full shadow-2xl hover:bg-[#B8860B] transition-all duration-300 hover:scale-110"
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-[380px] h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col border-4 border-[#d4af37]">
          {/* Header */}
