  ...
  const handleShare = (platform: string) => {
    ...
    switch (platform) {
      ...
      case "linkedin":
        ...
        break;
      case "instagram":
        // Instagram não tem compartilhamento direto via URL, então copiamos o texto
        navigator.clipboard.writeText(shareText);
        toast.success("Texto copiado! Cole no Instagram para compartilhar.");
        setIsOpen(false);
        return;
      case "tiktok":
        // TikTok também não tem compartilhamento direto via URL
        navigator.clipboard.writeText(shareText);
        toast.success("Texto copiado! Cole no TikTok para compartilhar.");
        setIsOpen(false);
        return;
      case "copy":
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="grid grid-cols-2 gap-3 py-4">
            ...
            <Button
              ...
              className="gap-2 bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] hover:opacity-90 text-white"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
